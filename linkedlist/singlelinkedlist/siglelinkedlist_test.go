...
func checkListPointers(t *testing.T, l *List, es []*Node) {
	...
	if len(es) == 0 {
		if l.root.next != nil && l.root.next != root {
			t.Errorf("l.root.next = %p,; both should both be nil or %p", l.root.next, root)
		}
		return
	}
	// len(es) > 0
...
func TestMove2(t *testing.T) {
	...
	l.MoveAfter(e3, e3)
	checkListPointers(t, l, []*Node{e1, e2, e3, e4})
	l.print("MoveAfter(e3, e3) ")

	l.MoveBefore(e2, e2)
		checkListPointers(t, l, []*Node{e1, e2, e3, e4})
	l.print("MoveBefore(e2, e2) ")

	l.MoveAfter(e3, e2)
		checkListPointers(t, l, []*Node{e1, e2, e3, e4})
	l.print("MoveAfter(e3, e2)")

	l.MoveBefore(e2, e3)
	l.print("MoveBefore(e2, e3)")
	checkListPointers(t,l,[]*Node{e1,e2,e3,e4})
		//checkListPointers(t, l, []*Node{e1, e2, e3, e4})
